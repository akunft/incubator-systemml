...
public class MapmmChainFLInstructionTest {
    ...
    public void testXtXvInstruction() throws Exception {
        ...
        DataSet<Tuple2<MatrixIndexes, MatrixBlock>> X = DataSetConverterUtils.csvToBinaryBlock(env, xRaw, xMcOut, false,
                ",", false, 0.0);
        ...
        DataSet<Tuple2<MatrixIndexes, MatrixBlock>> v = DataSetConverterUtils.csvToBinaryBlock(env, vRaw, vMcOut, false,
                ",", false, 0.0);
    ...
    public void testXtwXvInstruction() throws Exception {
        ...
        DataSet<Tuple2<MatrixIndexes, MatrixBlock>> w = DataSetConverterUtils.csvToBinaryBlock(env, wRaw, wMcOut, false,
                ",", false, 0.0);
