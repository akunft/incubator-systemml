...
public class TsmmFLInstructionTest {
    ...
    public void testTSMMWithInstructions() throws Exception {
        ...
        VariableCPInstruction readVar1 = VariableCPInstruction.parseInstruction(
                "CP°createvar°pREADm°" + testFile + "°false°csv°306°4°-1°-1°-1°false°false°,°true°0.0");
        VariableCPInstruction createVar1 = VariableCPInstruction.parseInstruction(
                "CP°createvar°_mVar1°scratch_space//_p22279_127.0.1.1//_t0/temp1°true°binaryblock°306°4°1000°1000°-1°false");
        ReblockFLInstruction reblock = ReblockFLInstruction.parseInstruction(
        ...
        VariableCPInstruction createvar2 = VariableCPInstruction.parseInstruction(
                "CP°createvar°_mVar2°scratch_space//_p22279_127.0.1.1//_t0/temp2°true°binaryblock°306°4°1000°1000°-1°false");
        ...
        VariableCPInstruction createVar3 = VariableCPInstruction.parseInstruction(
                "CP°createvar°_mVar3°scratch_space//_p22279_127.0.1.1//_t0/temp3°true°binaryblock°4°4°1000°1000°-1°false");
        TsmmFLInstruction inst = TsmmFLInstruction.parseInstruction(
                "FLINK°tsmm°_mVar2·MATRIX·DOUBLE°_mVar3·MATRIX·DOUBLE°LEFT");
        VariableCPInstruction rmVar2 = VariableCPInstruction.parseInstruction("CP°rmvar°_mVar2");
        WriteFLInstruction wrVar3 = WriteFLInstruction.parseInstruction(
                "FLINK°write°_mVar3·MATRIX·DOUBLE°" + outputPath + "·SCALAR·STRING·true°csv·SCALAR·STRING·true°false°,°false°true");
    ...
    public void testTSMMWithMLConext() throws Exception {
        ...
        DataSet<Tuple2<MatrixIndexes, MatrixBlock>> mat = DataSetConverterUtils.csvToBinaryBlock(env, input, mcOut,
                false, ",", false, 0.0);
